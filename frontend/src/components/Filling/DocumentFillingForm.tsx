...
export const DocumentFillingForm: React.FC<DocumentFillingFormProps> = ({
  ...
  const fillMutation = useMutation({
    ...
    onSuccess: (data) => {
      setFilledDocId(data.output_document_id || data.document_id);
  ...
  const idDocuments = documents.filter((d: any) =>
    d.document_type === 'id' || d.document_type === 'id_card' || d.filename.toLowerCase().includes('id')
  );
