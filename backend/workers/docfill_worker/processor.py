...
class DocumentFillingProcessor:
    ...
    def __init__(self):
        ...
        if not self.id_processor_id:
            print("Warning: DOCUMENTAI_ID_PROCESSOR_ID not set, will use mock extraction")

        # Initialize Document AI client
        if self.id_processor_id:
    ...
    def extract_id_data(self, gcs_uri: str) -> Dict[str, Any]:
        ...
        if not self.documentai_client:
            ...
            print("Using mock ID extraction (DOCUMENTAI_ID_PROCESSOR_ID not configured)")
            return {
                ...
                "document_number": "RO123456",
                "issue_date": "2020-01-10",
                "expiry_date": "2030-01-10",
                "address": "Str. Victoriei nr. 10, București",
                "cnp": "1900515123456",
                "confidence_scores": {"family_name": 0.95, "given_names": 0.93},
                "average_confidence": 0.94,
                "raw_text": "Mock ID Card Data"
            }
    ...
    def _get_template_path(self, template_name: str) -> Optional[str]:
        ...
        # If template doesn't exist, create a simple one for testing
        print(f"Warning: Template {template_name}.pdf not found, creating sample template")
        return None
